...
export const EVENT_TYPES = ['global', 'downlock', 'uplock', 'imagery', 'accept_pur', 'decline_pur'] as const
export const REQUEST_TYPES = ['downlock', 'uplock', 'imagery', 'accept_pur', 'decline_pur'] as const
